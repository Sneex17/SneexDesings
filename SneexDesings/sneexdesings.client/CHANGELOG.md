...
- Cree un proyecto vue con create-vite: `npm init --yes vue@latest sneexdesings.client -- --eslint  --typescript `.
...
- Agregar `shims-vue.d.ts` para tipos básicos.
- Crear archivo de proyecto (`sneexdesings.client.esproj`).
